...
- [x] Seat stay / chain stays
  ...
  - [ ] Make chain / seatstays use realistic bends
  - [ ] Generate chain / seat stay shapes depending on specified part sizes and bend angles
  - [ ] Put stay generation functions / modules back into `bframe_parts.scad`
